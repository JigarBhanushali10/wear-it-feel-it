...
const {userAuthData} = useContext(AuthContext)
  return (
    <div className='d-flex justify-content-between align-items-center mt-3 px-2 mx-2 px-xl-5 mx-xl-5 flex-wrap '>
      ...
      <div className=' globalSearchContainer d-flex me-2 border border-dark  align-items-center flex-item bg-white'>
       <label htmlFor="globalSearch"> <span className=" mx-3 icon-search fs-4 text-muted"></span></label>
