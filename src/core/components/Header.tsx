...
function Header() {
  ...
  return (
    <div className='d-flex justify-content-between align-items-center mt-3 px-2 mx-2 px-xl-5 mx-xl-5 flex-wrap '>
      ...
      <span className='mx-3 d-flex justify-content-center align-items-center flex-item' onClick={() => { navigate('cart') }}>
      ...
      {userAuthData &&
        <span className="icon-user fs-4 mx-3 flex-item " onClick={() => { navigate('/profile') }}></span>
