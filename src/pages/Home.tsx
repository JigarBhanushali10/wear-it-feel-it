...
const Home = () => {
  ...
  return (
    <div className="flex-grow-1">
      {/* hero section */}
      <section className="mpy-5 bg-secondary pt-4 ">
        <div className="container">
          <div className="row">
            <div className="col-12 col-sm-6 ">
              {/* slider headings and button */}
              <div className="d-flex justify-content-center justify-content-xxl-end align-items-center h-100">
                <div className="text-center text-md-start ">
                  ...
                  <button
                    className="btn btn-outline-primary px-lg-5 py-lg-3 mt-4 fs-lg-4 rounded-pill "
                    onClick={() => scrollsection(myRef)}
                  >
                    Explore Now
                  </button>
                </div>
      ...
      <section className="my-5 last-arraivals " id="last-arraivals">
